...
const models: TsoaRoute.Models = {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "AuthServiceDTO.SignInOutput": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"companyId":{"dataType":"string"},"jwt":{"dataType":"string","required":true},"email":{"dataType":"string","required":true},"name":{"dataType":"string","required":true},"id":{"dataType":"string","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "AuthServiceDTO.SignInInput": {
        "dataType": "refAlias",
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/auth/sign-up',
            ...
            const args = {
                    input: {"in":"body","name":"input","required":true,"ref":"AuthServiceDTO.SignUpInput"},
            };
        ...
        app.post('/auth/sign-in',
            ...
            const args = {
                    input: {"in":"body","name":"input","required":true,"ref":"AuthServiceDTO.SignInInput"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/auth/email-verification',
            ...(fetchMiddlewares<RequestHandler>(AuthController)),
            ...(fetchMiddlewares<RequestHandler>(AuthController.prototype.emailVerification)),

            async function AuthController_emailVerification(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.emailVerification.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/auth/refresh-token',
            ...
            async function AuthController_refreshToken(request: any, response: any, next: any) {
            const args = {
            };
